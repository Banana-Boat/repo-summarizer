...
if __name__ == '__main__':
    ...
    for dirname in tqdm(os.listdir(root_path)):
        ...
        package_summary_table = allclasses_soup.find(
            'table', class_='packagesSummary')
        if package_summary_table is None:
            continue

        overview_summary_tbody = package_summary_table.find('tbody')
    ...
    with open('./packages_v3.jsonl', 'w', encoding='utf-8') as f:
